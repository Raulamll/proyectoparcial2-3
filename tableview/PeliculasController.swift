...
class PeliculasController: UIViewController, UITableViewDelegate, UITableViewDataSource {
    ...
    override func viewDidLoad() {
        ...
        peliculas.append(Pelicula(titulo: "Interstellar", año: "2014", director: "Christopher Nolan", genero: "Sci-fi/Aventura", imagen: "interstellar", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "The Godfather", año: "1972", director: "Francis Ford Coppola", genero: "Crimen/Thriller", imagen: "the-godfather", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "The Godfather: Part II", año: "1974", director: "Francis Ford Coppola", genero: "Crimen/Drama", imagen: "the-godfather-2", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "The Godfather: Part III", año: "1990", director: "Francis Ford Coppola", genero: "Crimen/Drama", imagen: "the-godfather-3", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "The Social Network", año: "2010", director: "David Fincher", genero: "Drama/Historia", imagen: "the-social-network", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Goodfellas", año: "1990", director: "Martin Scorsese", genero: "Crimen/Drama", imagen: "goodfellas", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "The Wolf of Wall Street", año: "2013", director: "Martin Scorsese", genero: "Comedia/Drama", imagen: "the-wolf-of-wallstreet", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Scarface", año: "1983", director: "Brian De Palma", genero: "Crimen/Drama", imagen: "scarface", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Pulp Fiction", año: "1994", director: "Quentin Tarantino", genero: "Crimen/Drama", imagen: "pulp-fiction", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Inglorious Basterds", año: "2009", director: "Quentin Tarantino", genero: "Guerra/Accion", imagen: "inglorious-basterds", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Forrest Gump", año: "1994", director: "Robert Zemeckis", genero: "Drama/Romance", imagen: "forrest-gump", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Hereditary", año: "2018", director: "Ari Aster", genero: "Horror/Drama", imagen: "hereditary", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Midsommar", año: "2019", director: "Ari Aster", genero: "Horror/Thriller", imagen: "midsommar", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Southpaw", año: "2015", director: "Antoine Fuqua", genero: "Drama/Thriller", imagen: "southpaw", productora: "Paramount Pictures", rating: "8.6"))
        peliculas.append(Pelicula(titulo: "Whiplash", año: "2014", director: "Damien Chazelle", genero: "Drama", imagen: "whiplash", productora: "Paramount Pictures", rating: "8.6"))
